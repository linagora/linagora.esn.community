...
describe('The Community Angular module', function() {
  ...
  describe('communityAPI service', function() {
    ...
    describe('list() function', function() {
      ...
      it('should send a GET to /community/api/communities?domain_id=:id', function() {
        this.$httpBackend.expectGET('/community/api/communities?domain_id=' + this.domainId).respond(200, []);
    ...
    describe('get() function', function() {
      ...
      it('should send a GET request to /community/api/communities/:uuid', function() {
        this.$httpBackend.expectGET('/community/api/communities/' + this.communityId).respond(200, this.response, this.headers);
    ...
    describe('del() function', function() {
      ...
      it('should send a DEL request to /community/api/communities/:uuid', function() {
        this.$httpBackend.expectDELETE('/community/api/communities/' + this.communityId).respond(204);
    ...
    describe('update() function', function() {
      ...
      it('should send a PUT request to /community/api/communities/:id/title', function() {
        this.$httpBackend.expectPUT('/community/api/communities/' + this.communityId).respond(200);
        this.communityAPI.update(this.communityId, this.body);
        this.$httpBackend.flush();
      });

      it('should send a PUT to /community/api/communities/:id/title with given query parameters ', function() {
        this.$httpBackend.expectPUT('/community/api/communities/' + this.communityId).respond(200);
        this.communityAPI.update(this.communityId, this.body);
        this.$httpBackend.flush();
      });
    ...
    describe('getMembers() function', function() {
      ...
      it('should send a GET request to /community/api/collaborations/community/:id/members', function() {
        this.$httpBackend.expectGET('/community/api/collaborations/community/' + this.communityId + '/members').respond(200, {});
    ...
    describe('getMember() function', function() {
      ...
      it('should send a GET request to /community/api/communities/:id/members/:user', function() {
        this.$httpBackend.expectGET('/community/api/communities/' + this.communityId + '/members/' + this.userId).respond(200, {});
    ...
    describe('The directive controller', function() {
      describe('The getInvitablePeople function', function() {
        ...
        it('should set displaynames on users if esnCollaborationClientService#getInvitablePeople works', function() {
          ...
          expect(userUtils.displayNameOf(res.data[1])).to.equal(user2.preferredEmail);
        });
      });
