...
angular.module('linagora.esn.community')
  ...
  .factory('communityAPI', function(communityRestangular, httpConfigurer, $upload) {
    ...
    function list(domain, options) {
      ...
      return communityRestangular.all('communities').getList(query);
    }

    function get(id) {
      return communityRestangular.one('communities', id).get();
    }

    function del(id) {
      return communityRestangular.one('communities', id).remove();
    }

    function create(body, query) {
      return communityRestangular.all('communities').post(body, query);
    }
    ...
    function getMembers(id) {
      return communityRestangular.one('collaborations').one('community', id).one('members').get();
    }

    function getMember(id, member) {
      return communityRestangular.one('communities', id).one('members', member).get();
    }
  ...
  .directive('communityCreateButton', function() {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-create-button.html'
    };
  })
  .directive('communityViewSubheader', function() {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-subheader.html'
    };
  })
  .directive('communitiesViewSubheader', function() {
    return {
      restrict: 'E',
      templateUrl: '/community/views/communities-subheader.html'
    };
  })
  ...
  function(WidgetWizard, selectionService, communityCreationService, $timeout, $state, $alert, $rootScope) {
    function link($scope, element) {
      $scope.wizard = new WidgetWizard([
        '/community/app/community-creation-wizard-1',
        '/community/app/community-creation-wizard-2',
        '/community/app/community-creation-wizard-3'
      ]);
    ...
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-create.html',
      scope: {
        user: '=',
        domain: '=',
        createModal: '='
  ...
  .directive('communityButtonJoin', function(communityService) {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-button-join.html',
      replace: true,
      link: function($scope) {
  ...
  .directive('communityButtonLeave', function(communityService) {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-button-leave.html',
      replace: true,
      link: function($scope) {
        $scope.disabled = false;
  ...
  .directive('communityButtonRequestMembership', function(communityService) {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-button-request-membership.html',
      replace: true,
      link: function($scope) {
        $scope.disabled = false;
  ...
  .directive('communityButtonCancelRequestMembership', function(communityService) {
    return {
      restrict: 'E',
      templateUrl: '/community/views/community-button-cancel-request-membership.html',
      replace: true,
      link: function($scope) {
        $scope.disabled = false;
  ...
  .directive('communityMembershipRequestsWidget', function($rootScope, esnCollaborationClientService) {
    return {
      ...
      templateUrl: '/community/views/community-membership-requests-widget.html',
  ...
  .directive('communityMembershipRequestsActions', function($rootScope, esnCollaborationClientService) {
    return {
      ...
      templateUrl: '/community/views/community-membership-requests-actions.html',
      controller: function($scope) {
  ...
  .directive('communityMemberAvatar', function() {
    return {
      ...
      templateUrl: '/community/views/community-member-avatar.html',
      controller: function($scope) {
        var title = '';
  ...
  .directive('communityInviteUsers', function($q, esnCollaborationClientService, communityService, session, userUtils) {
    return {
      ...
      templateUrl: '/community/views/community-invite-users.html',
  ...
  .directive('communityActionsToolbar', function() {
    return {
      ...
      templateUrl: '/community/views/community-actions-toolbar.html'
    };
  })
