...
module.exports = (dependencies, router) => {
   ...
   */
  router.get('/communities', domainMiddleware.loadFromDomainIdParameter, authorizationMW.requiresDomainMember, communities.list);
   ...
   *         $ref: "#/responses/cm_500"
   */
  router.post('/communities', communities.loadDomainForCreate, authorizationMW.requiresDomainMember, communities.create);
